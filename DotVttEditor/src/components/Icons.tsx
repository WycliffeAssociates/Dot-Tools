...
export function DotLogo() {
  return <img src={dotLogoDark.src} width="144" alt="" />;
}
export function DotLogoHandsOnly(props: IconProps) {
  ...
  >
    <g transform="matrix(1.35 0 0 -1.35 540 540)" clip-path="url(#a)">
      <clipPath id="a">
        <path transform="translate(-656.26 -541.37)" d="M0 1080h1920V0H0Z" stroke-linecap="round" />
      </clipPath>
      <path
        style={{
          stroke: "none",
...
export function IconMenu(props: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class={props.classNames || ""}>
...
export function IconExternalLink(props: IconProps) {
  return (
    <svg class={props.classNames || ""} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3m-2 16H5V5h7V3H5c-1.11 0-2 .9-2 2v14a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2v-7h-2v7Z"
      />
    </svg>
  );
}
